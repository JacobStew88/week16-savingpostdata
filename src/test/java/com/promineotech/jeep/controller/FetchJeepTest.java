...
class FetchJeepTest {
	...
	class TestsThatDoNotPolluteTheApplicationContext{
		...
		void testThatJeepsAreReturnedWhenAValidModelAndTrimAreSupplied() {
			//Given: a valid model and trim URI
		...
		@Test
		void testThatAnErrorMessageAreReturnedWhenAnUnknownModelAndTrimAreSupplied() {
			//Given: a valid model and trim URI
			JeepModel model = JeepModel.WRANGLER;
		...
		void testThatAnErrorMessageAreReturnedWhenAnInvalidModelAndTrimAreSupplied(
	...
	static Stream<Arguments> parametersForInvalidInput() {
		// @formatter:off
		return Stream.of(
			arguments("WRANGLER", "@lkjao", "Trim contains non-alpha-numeric characters"),
			arguments("WRANGLER" , "C".repeat(Constants.TRIM_MAX_LENGTH + 1), "trime length too long"),
